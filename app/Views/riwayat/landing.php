...
<h5 class="mb-4 text-dark fw-bold">Riwayat Pengecekan (Preventive MFG 1)</h5>
  ...
  <div class="col-md-4">
    <div class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden">
      <div class="card-body p-4 d-flex flex-column">
        ...
        <p class="card-text text-muted mb-4">Lihat riwayat hasil pengecekan instalasi kabel mesin ke bartop, hydraulic, saluran amano, vacuum, dan selang oli.</p>
