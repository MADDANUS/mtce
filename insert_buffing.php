...
$data = [
    ...
    ['section_check' => 'MOTOR SPINDLE', 'bagian_check' => 'PULLEY MOTOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'MOTOR SPINDLE', 'bagian_check' => 'AS MOTOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'MOTOR SPINDLE', 'bagian_check' => 'BELT MOTOR', 'point_check' => 'CHECK CONDITION AND TENSION'],
    ['section_check' => 'MOTOR SPINDLE', 'bagian_check' => 'BELT ADJUSTER SPEED', 'point_check' => 'CHECK CONDITION AND TENSION'],
    ['section_check' => 'MOTOR SPINDLE', 'bagian_check' => 'FAN MOTOR', 'point_check' => 'CLEANING UNIT'],
    ...
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'GEARHEAD MOTOR CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'PULLEY MOTOR CONVEYOR', 'point_check' => 'CHECK CONDITION AND FUNCTION'],
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'AS MOTOR CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ...
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'BELT / RANTAI CONVEYOR', 'point_check' => 'CHECK CONDITION AND TENSION'],
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'RAIL / BASE CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'CYLINDER UP DOWN CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'SOLENOID CONVEYOR', 'point_check' => 'CHECK CONDITION AND FUNCTION'],
    ['section_check' => 'CONVEYOR IN', 'bagian_check' => 'SENSOR CONVEYOR', 'point_check' => 'CHECK CONDITION AND FUNCTION'],
    ...
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'GEARHEAD MOTOR CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'PULLEY MOTOR CONVEYOR', 'point_check' => 'CHECK CONDITION AND FUNCTION'],
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'AS MOTOR CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ...
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'BELT / RANTAI CONVEYOR', 'point_check' => 'CHECK CONDITION AND TENSION'],
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'RAIL / BASE CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'CYLINDER UP DOWN CONVEYOR', 'point_check' => 'CHECK CONDITION'],
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'SOLENOID CONVEYOR', 'point_check' => 'CHECK CONDITION AND FUNCTION'],
    ['section_check' => 'CONVEYOR OUT', 'bagian_check' => 'SENSOR CONVEYOR', 'point_check' => 'CHECK CONDITION AND FUNCTION'],
...
echo "Successfully inserted " . count($data) . " parameters for BUFFING.\n";
